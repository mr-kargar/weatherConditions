...
function Header() {
  return (
    <>
      ...
      <div className="flex item-center container max-w-6xl p-2 px-4 shadow font-bold justify-between">
        <ul className='flex gap-4'>
          <li className='cursor-pointer'>version 1 </li>
          <li className='cursor-default text-gray-400'>version 2 </li>
          <li className='cursor-default text-gray-400'>version 3 </li>
        </ul>
        <ul>
          <li className='cursor-default text-gray-400'>ورژن فارسی</li>
        </ul>
      </div>
    </>
  )
